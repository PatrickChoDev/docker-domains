...
const DNSMasqHeaderConfig = `# dnsmasq.conf file for docker-domains
# DO NOT EDIT THIS FILE BY HAND, IT IS GENERATED BY docker-domains
# 
# This file is **removed** when docker-domains is stopped, and when
...
func Initialize() {
	...
	var err error
	TempDir, err = os.MkdirTemp("", "docker-dnsmasq-")
	log.Println(TempDir)
	if err != nil {
		log.Fatal(err)
	}
